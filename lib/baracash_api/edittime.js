function GetPluginSettings()
{
	return {
		...
		"rotatable":	false,
		"dependency": "fingerprint2.min.js",
		"flags":		0
	};
};
...
AddExpression(1, ef_return_string, 
              "Get gift Name", "String", "GetPrizeName", 
              'Get prize Name ');
...
AddExpression(1, ef_return_number, 
              "Get gift val", "Number", "GetPrizeValue", 
              'Get gift val');			  
			  
AddExpression(1,ef_return_string,"Get Fingerprint", "String", "GetFingerPrint","Get Fingerprint)")

AddExpression(1,ef_return_number,"isWinning", "boolean", "IsWinning","Get isWinning)")
