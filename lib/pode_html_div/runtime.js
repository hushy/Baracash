...
(function ()
{
	...
	function recaptcha_callback(){
		this.runtime.trigger(cr.plugins_.HTML_Div_Pode.prototype.cnds.OnReCaptchaResponse, this);
	}
	//////////////////////////////////////
	// Conditions
	pluginProto.cnds = {};
	...
	cnds.OnReCaptchaResponse = function (){
	...
	exps.GetReCaptcha = function (ret)
	{	
	if((typeof grecaptcha !== 'undefined')){
		ret.set_string(grecaptcha.getResponse());
	}else{
		ret.set_string("");
	}
	};
