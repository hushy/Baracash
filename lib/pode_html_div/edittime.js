...
AddCondition(4, cf_none, "On captcha response", "CaptchaResponse", 
             "On Captcha response get", 
             "Triggered on captcha response", "OnReCaptchaResponse");
...
AddExpression(2, ef_return_string, "Get Captcha response", "response", "GetReCaptcha", "Get the captcha response.");
