...
AddNumberParam("radius", "radius tested for transparency", "0");
AddNumberParam("alpha", "alphaThreshold", "0");
AddCondition(0,	cf_none, "Is alpha less than", "testCategory", "Compare alpha less than {2}", "Compare alpha of the pixel in canvas with threshold", "IsAlphaLessThan");
...
AddStringParam("color", "Use color name, hex \"#FFA500\", \"rgb(0-255,0-255,0-255)\", \"rgba(0-255,0-255,0-255,0-1)\", \"hsl(0-360,0-100%,0-100%)\", or \"hsla(0-360,0-100%,0-100%,0-1)\" ", "\"black\"");
AddNumberParam("line_width", "Width of line", "1.0");
AddAction(24, 0, "Clear Line", "Canvas", "Draw line from ({0},{1}) to ({2},{3}) with color {4} and line width {5}", "clear a line.", "ClearLine");
...
AddStringParam("color", "Use color name, hex \"#FFA500\", \"rgb(0-255,0-255,0-255)\", \"rgba(0-255,0-255,0-255,0-1)\", \"hsl(0-360,0-100%,0-100%)\", or \"hsla(0-360,0-100%,0-100%,0-1)\" ", "\"black\"");
AddNumberParam("line_width", "Width of line", "1.0");
AddAction(23, 0, "Clear Circle", "Canvas", "Clear circle from center ({0},{1}), with radius {2}, color {3} and line width {4}", "Clear a circle.", "clearCircle");
